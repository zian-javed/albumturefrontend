...
<footer>
    ...
    <ul className="footer-list">
        ...
        <li className="footer-item">
            <a href="https://github.com/Volandis"> <img src="./images/githublogo.png" alt="Link to Jamie H GitHub profile"/> </a>
        </li>
        <li className="footer-item">
            <a href="https://github.com/LittleManc"> <img src="./images/jstewartprofilepic.jpg" alt="Link to Jessica Stewart GitHub profile"/> </a>
        </li>
        <li className="footer-item">
